        ...
        <div class="c-pos" @click="cancel">
            <div @click.stop>
                ...
                <div class="p-cnt">
                    ...
                    <p class="c-p"><span>打卡地点：</span><img src="./img/pos.png">{{info.addressArr}}</p>
                    <p class="c-ta"><span>备注：</span><textarea v-model="info.rmks"></textarea></p>
                    <p class="c-ta">
...
<script>
    export default {
        ...
        mounted() {
            ...
            let geolocation = new qq.maps.Geolocation("YOIBZ-PPXWF-RB2JB-JXJTU-M6T62-6LB3Z", "haiTianDrive");
