  ...
  <div id="container">
    <div class="search">
      <div class="search-text">
        <span class="s-tit">工号：</span>
        <input type="text" class="c-ip" placeholder="请输入员工ID" v-model="IDNumber" />
      </div>
      <div class="search-text">
        <span class="s-tit">密码：</span>
        <input type="password" class="c-ip" placeholder="请输入登录密码" v-model="ipassword" />
      </div>
      <div>
